...
export const COMPONENT_DEFINITIONS = [
  {
    ...
    icon: '🔘',
    category: 'Bases',
    defaultProps: { label: 'Bouton', bgColor: '#6C63FF', textColor: '#FFFFFF', fontSize: 16, fontFamily: 'Nunito', borderRadius: 12, opacity: 1, iconName: '', iconSet: 'lucide', iconPosition: 'left', emoji: '', navigateTo: '' },
  ...
  },
  {
    ...
    icon: '📝',
    category: 'Bases',
    defaultProps: { label: 'Mon texte ici', textColor: '#1F2937', fontSize: 16, fontFamily: 'Nunito', fontWeight: 'normal', opacity: 1, navigateTo: '' },
  ...
  },
  {
    ...
    icon: '📱',
    category: 'Navigation',
    defaultProps: { title: 'Mon App', bgColor: '#6C63FF', textColor: '#FFFFFF', fontFamily: 'Nunito', showBack: true, opacity: 1, navigateTo: '' },
